...
export default function Faq() {
  ...
  const email = contactData.email || 'sales@ambhujamaytri.in';
  const phone = contactData.phone || '+91 98490 12345';
  const siteAddress = contactData.siteAddress || 'Maytri Ambhuja, Near ORR Exit 12, Shamshabad - Sanghi Nagar Road, Hyderabad, Telangana 501511';
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: `Maytri Ambhuja is located in Hyderabad, Telangana. The site experience center is situated at ${siteAddress}.`
    },
    {
      q: "How can I request the brochure?",
      a: `You can request the project brochure by clicking the 'Download Brochure' button on this website or contacting our sales team directly at ${email}.`
    },
    {
      q: "How can I schedule a site visit?",
      a: `You can schedule a site visit by submitting the enquiry form on this page or by contacting our team at ${phone}.`
    }
  ];
