...
export default function Hero({ onOpenBookVisit }) {
  ...
  const posterUrl = media.heroPoster || CLOUDINARY_MEDIA.heroPoster;
  const badgeText = heroData.eyebrowBadge || heroData.badge || 'MAYTRI AMBHUJA';
  ...
  const defaultIcons = [Trees, Home, Building2, Shield];
  const keyHighlights = (Array.isArray(heroData.highlights) && heroData.highlights.length > 0)
        ...
        {!isVideoLoaded && (
          <div className="hero-video-loader" aria-hidden="true">
            <div className="hero-loader-pulse">
              ...
              <img src="/ambhuja-icon.png" alt="Maytri Ambhuja" className="hero-loader-icon" />
            </div>
