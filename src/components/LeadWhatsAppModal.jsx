...
export const WHATSAPP_NUMBER = "919849012345";
...
export default function LeadWhatsAppModal({ 
  ...
  const activeWaNumber = (contactData.whatsapp || contactData.phone || WHATSAPP_NUMBER).replace(/[^0-9]/g, '');
  ...
  const handleSubmit = (e) => {
    ...
    try {
      ...
      const waUrl = `https://wa.me/${activeWaNumber}?text=${encodeURIComponent(textMessage)}`;
