...
export default function LeadForm({ onOpenBrochure }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setErrors({ form: `Unable to submit right now. Please call us directly at ${phone}.` });
    } finally {
        ...
        <div className="lead-grid">
          ...
          <div className="lead-info-card">
            ...
            <h3 className="lead-heading">
              Make Maytri Ambhuja Your Next Address
            </h3>
            ...
            <div className="direct-cta-list">
              <a href={`tel:${phone.replace(/\s+/g, '')}`} className="direct-cta-item">
                <div className="direct-cta-icon">
                  <Phone size={18} />
                </div>
                <div>
                  <span className="direct-cta-lbl">Call Direct</span>
                  <strong className="direct-cta-val">{phone}</strong>
                </div>
              </a>

              <a href={`mailto:${email}`} className="direct-cta-item">
                <div className="direct-cta-icon">
                  <Mail size={18} />
                </div>
                <div>
                  <span className="direct-cta-lbl">Official Email</span>
                  <strong className="direct-cta-val">{email}</strong>
                </div>
              </a>
